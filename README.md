...
1. Harmonic regression + (S)ARIMA : We model yearly seasonality with fourier modes of annual frequency and its harmonics as exogenenous variables while jointly fitting an ARIMA model (possibly with weekly seasonality for the daily data) to capture residual autocorrelation.
